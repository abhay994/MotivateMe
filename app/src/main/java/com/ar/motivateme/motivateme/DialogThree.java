...
public class DialogThree extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        handler = new Handler();
        return inflater.inflate(R.layout.fragment_dialog_three, container, false);
    }
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        imagew = (ImageView) view.findViewById(R.id.wallaper3);
        images = (ImageView) view.findViewById(R.id.share3);
        ...
        String mpost_key = getArguments().getString("edttext5");
    ...
    private final Runnable revealAnimationRunnable = new Runnable() {
        ...
        public void run() {
            ...
            int cy = relativeLayout1.getTop()+relativeLayout1.getBottom()/2;
