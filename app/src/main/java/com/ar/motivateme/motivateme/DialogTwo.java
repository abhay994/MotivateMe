...
public class DialogTwo extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_dialog_two, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        handler = new Handler();
        final ImageView imageView = (ImageView) view.findViewById(R.id.imageView22);
        imagew = (ImageView) view.findViewById(R.id.wallaper2);
        images = (ImageView) view.findViewById(R.id.share2);
        ...
        String mpost_key = getArguments().getString("edttext1");
    ...
    private final Runnable revealAnimationRunnable = new Runnable() {
        @Override
        public void run() {
            int cx = relativeLayout1.getLeft()+relativeLayout1.getRight();
            int cy = relativeLayout1.getTop()+relativeLayout1.getBottom();
